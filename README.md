# [SmartBot](https://telegram.me/SmartTG)

**An advanced and powerful administration bot based on [yagop/telegram-bot](https://github.com/yagop/telegram-bot) licensed under the [GNU General Public License](https://github.com/p00ria/SmartBot/blob/master/LICENSE)**.
# Features
...
>
>/sync_gbans
>>Sync your global bans with SmartBot
>
>[!/]unbanall [id]
>>[!/]unbanall 123456789
...
cd $HOME
git clone https://github.com/p00ria/SmartBot.git
cd SmartBot
chmod +x launch.sh
./launch.sh install
...
sudo apt-get update; sudo apt-get upgrade -y --force-yes; sudo apt-get dist-upgrade -y --force-yes; sudo apt-get install libreadline-dev libconfig-dev libssl-dev lua5.2 liblua5.2-dev libevent-dev libjansson* libpython-dev make unzip git redis-server g++ -y --force-yes && git clone https://github.com/p00ria/SmartBot.git && cd SmartBot && chmod +x launch.sh && ./launch.sh install && ./launch.sh
```
### Realm configuration
...
[@Smart_CH](https://telegram.me/Smart_CH)
